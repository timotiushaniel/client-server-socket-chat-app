...
public class SocketClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            try {
                ...
                //Proses setelah menerima response verifikasi user dari server
                        ...
                        if(choice != 0) {
                            if(clientSocket != null && out != null && in != null) {
                                ...
                                switch(choice) {
                                    ...
                                    case(3):
                                        String str_resp4 = in.readLine();
                                        ArrayList<Option3> list3 = gson.fromJson(str_resp4, new TypeToken<ArrayList<Option3>>(){}.getType());
                                        if(list3.isEmpty()){
                                            System.out.println("-");
                                        }
                                        else{
                                            Response.displayOption3(list3);
                                        }
                                        break;
    ...
    private static void mainMenuResponse() throws IOException {
        ...
        System.out.println(mainMenu5);
        String mainMenu6 = in.readLine();
        System.out.print(mainMenu6);
    }
    ...
    private static void menuPilihan3Response() throws IOException{
        String line1 = in.readLine();
